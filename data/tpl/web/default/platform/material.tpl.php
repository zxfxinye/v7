	...
	<div class="material">
		...
		<div class="material-appmsg">
			<div class="material-list-head clearfix">
				...
				<div class="pull-right">
					<?php  if($_W['account']['level'] > 2 || $_W['account']['type'] == ACCOUNT_TYPE_XZAPP_NORMAL && $_W['account']['isconnect'] = 1) { ?>
					<a href="javascript:;" ng-click="sync('<?php  echo $type;?>')" class="btn btn-default">同步<?php  echo $_W['account']['type_name'];?></a>
					<?php  } ?>
			...
			<div class="btn-group we7-btn-group" style="top:15px;">
				...
				<a href="<?php  echo url('platform/material', array('type' => $type, 'server' => MATERIAL_WEXIN))?>" class="btn <?php  if($server == MATERIAL_WEXIN) { ?> active <?php  } ?>"><?php  echo $_W['account']['type_name'];?></a>
		...
		<div class="material-appmsg">
			...
			<div class="material-list-head clearfix">
				<div class="action">
					<?php  if($_W['account']['level'] > 2 || $_W['account']['type'] == ACCOUNT_TYPE_XZAPP_NORMAL && $_W['account']['isconnect'] = 1) { ?>
					<a href="javascript:;" class="btn btn-default" ng-click="sync('<?php  echo $type;?>')">同步<?php  echo $_W['account']['type_name'];?></a>
					<?php  } ?>
					<?php  if($server == MATERIAL_WEXIN) { ?>
					<a href="javascript:;" class="btn btn-primary we7-margin-left" ng-click="upload('image', true, true)">上传<?php  echo $_W['account']['type_name'];?>图片</a>
					<?php  } else { ?>
		...
		<div class="upload-queue"></div>
			<div class="material-list-head clearfix">
				<div class="action">
					...
					<a href="javascript:;" class="btn btn-default" ng-click="sync('voice')">同步<?php  echo $_W['account']['type_name'];?></a>
					<?php  } ?>
					<?php  if($server == MATERIAL_WEXIN) { ?>
					<a href="javascript:;" class="btn btn-primary we7-margin-left" ng-click="upload('voice', true, true)">上传<?php  echo $_W['account']['type_name'];?>语音</a>
					<?php  } else { ?>
