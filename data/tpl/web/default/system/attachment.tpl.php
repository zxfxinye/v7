...
<div class="clearfix">
	...
	<?php  } ?>
		<h5 class="page-header">附件空间设置</h5>
		<div class="form-group">
			<label class="col-sm-2 control-label">空间容量</label>
			<div class="col-sm-5">
				<div class="input-group">
					<input name="upload[attachment_limit]" value="<?php  echo $upload['attachment_limit'];?>" type="number" class="form-control">
					<span class="input-group-addon">M</span>
				</div>
				<div class="help-block">设置为 0 时不限制空间</div>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-5">
				...
				<div class="help-block">填写图片后缀名称, 如: jpg, 换行输入, 一行一个后缀 (如果为空，则采用系统默认设置).</div>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-5">
				<div class="input-group">
					<input name="upload[image][zip_percentage]" value="<?php  echo $upload['image']['zip_percentage'];?>" type="number" step="1" min="10"
		...
		<div class="form-group">
			...
			<div class="col-sm-5">
				...
				<div class="help-block">填写音频视频后缀名称, 如: mp3, 换行输入, 一行一个后缀 (如果为空，则采用系统默认设置).</div>
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label">支持文件大小</label>
