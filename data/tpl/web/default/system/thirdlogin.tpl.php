...
<?php  if($type == 'qq' || $type == 'wechat') { ?>
	<table class="table we7-table table-hover table-form we7-form">
		...
		<col width="230px" />
		<tr>
			<th class="table-label" colspan="2">QQ授权登录</th>
			<th class="text-right">
				<label>
					<div class="switch" ng-class="{'switchOn' : thirdlogin.qq.authstate}" ng-click="httpChange('authstate', 'qq')"></div>
				</label>
			</th>
		</tr>
		<tbody ng-show="thirdlogin.qq.authstate">
			<tr>
				<td class="text-left" colspan="2">QQ互联管理中心开发信息</td>
				<td class="we7-padding-right"></td>
			</tr>
			...
			<tr>
				<td class="text-left" colspan="3">QQ互联接入配置项</td>
			</tr>
			<tr>
				<td class="table-label">网站地址:</td>
				<td>
					<span><?php  echo $siteroot_parse_array['host'];?></span>
				</td>
				<td>
			...
			<tr>
				...
				<td><div class="link-group"><a href="javascript:;" id="copy-1" clipboard supported="supported" text="siteroot+'web/index.php'" on-copied="success('1')">点击复制</a></div></td>
			</tr>
		</tbody>
	</table>
		...
		<div class="we7-modal-dialog modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-primary" ng-click="httpChange('appid', 'qq')">确定</button>
	...
	<div class="modal fade" id="AppSecret" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="we7-modal-dialog modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-primary" ng-click="httpChange('appsecret', 'qq')">确定</button>
					<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
				</div>
			</div>
		</div>
	...
	<table class="table we7-table table-hover table-form we7-form">
		...
		<col width="230px" />
		<tr>
			<th class="table-label" colspan="2">微信授权登录</th>
			<th class="text-right">
				<label>
					<div class="switch" ng-class="{'switchOn' : thirdlogin.wechat.authstate}" ng-click="httpChange('authstate', 'wechat')"></div>
				</label>
			</th>
		</tr>
		<tbody ng-show="thirdlogin.wechat.authstate">
			<tr>
				<td class="text-left" colspan="2">微信登录配置信息</td>
				<td class="we7-padding-right"></td>
			</tr>
			...
			<tr>
				...
				<td>
					<div class="link-group">
						<a href="javascript:;" data-toggle="modal" data-target="#WechatID">修改</a>
					</div>
				</td>
			</tr>
			<tr>
				...
				<td>
					<div class="link-group"><a href="javascript:;" data-toggle="modal" data-target="#WechatSecret">修改</a></div>
				</td>
			</tr>
		</tbody>
	</table>
	<div class="modal fade" id="WechatID" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="we7-modal-dialog modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-primary" ng-click="httpChange('appid', 'wechat')">确定</button>
					<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
				</div>
			</div>
		</div>
	</div>
	<div class="modal fade" id="WechatSecret" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="we7-modal-dialog modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-primary" ng-click="httpChange('appsecret', 'wechat')">确定</button>
					<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
				</div>
			</div>
		</div>
