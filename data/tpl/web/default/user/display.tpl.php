...
<div class="keyword-list-head clearfix we7-margin-bottom">
	<form action="" method="get">
		...
		<label for="" class="col-sm-1 control-label" style="width: 60px;">用户状态</label>
		<div class="col-sm-2" style="width: 140px;">
			<select name="expire" class="form-control">
				<option value="0" <?php  if($_GPC['expire'] == 0) { ?>selected="selected"<?php  } ?>>不限</option>
				<option value="1" <?php  if($_GPC['expire'] == 1) { ?>selected="selected"<?php  } ?>>未到期</option>
				<option value="2" <?php  if($_GPC['expire'] == 2) { ?>selected="selected"<?php  } ?>>已到期</option>
			</select>
		</div>
