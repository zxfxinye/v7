	...
	<div class="panel we7-panel ">
		...
		<div class="panel-body we7-padding-vertical create">
			<div class="col-sm-3 text-center create-item">
				<div class="create-item__head">可创建公众号</div>
			...
			<div class="col-sm-3 text-center create-item">
				<div class="create-item__head">可创建小程序</div>
			...
			<div class="col-sm-3 text-center create-item">
				<div class="create-item__head">可创建PC</div>
			...
			<div class="col-sm-3 text-center create-item">
				<div class="create-item__head">可创建APP</div>
			...
			<div class="app-item" ng-repeat="list in last_accounts_modules">
				<div class="content">
					...
					<div class="app-item-footer">
						...
						<div class="type" ng-if="!list.account.type"><i class="wi wi-apply"></i></div>
						<div class="info">
							<div class="name text-over" ng-bind="list.account.name" ng-if="list.account.type"></div>
							<div class="name text-over" ng-bind="list.account.title" ng-if="!list.account.type"></div>
							...
							<div class="version" ng-if="!list.account.type">类型：应用</div>
						</div>
					</div>
					<div class="mask">
